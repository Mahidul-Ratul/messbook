...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('owner.messes.edit', $mess->id) }}" class="btn btn-primary">
            <i class="fa-solid fa-pen-to-square me-1"></i> Edit Mess
        </a>
    </div>
                    ...
                    <div class="list-group">
                        @forelse($mess->memberships as $member)
                            <div class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                <span class="badge bg-secondary">{{ $member->pivot->created_at->format('M d, Y') }}</span>
                            </div>
                        @empty
